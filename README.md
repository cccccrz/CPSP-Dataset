...
Subscribe to the zed_wrapper node and davis node, synchronize messages and save them to form a data set.



### TODO

Developed from the main branch, adding the function of synchronizing with davis node. The preliminary code has been completed and is waiting to be compiled and tested.
